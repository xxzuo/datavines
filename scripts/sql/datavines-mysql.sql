...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='自定义触发器存储';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Quartz日历';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='CronTrigger存储';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8  COMMENT='存储已经触发的trigger相关信息';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='存储jobDetails信息';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Quartz锁表，为多个节点调度提供分布式锁';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='存储集群中调度实例信息';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='存储简单的触发器，包括重复次数，间隔，以及已触发的次数';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='存储CalendarIntervalTrigger和DailyTimeIntervalTrigger';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='存储触发器的基本信息';
