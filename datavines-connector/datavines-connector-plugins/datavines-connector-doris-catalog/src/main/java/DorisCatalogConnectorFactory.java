...
import io.datavines.connector.plugin.AbstractJdbcConnectorFactory;

public class DorisCatalogConnectorFactory  extends AbstractJdbcConnectorFactory {

    @Override
    public ConnectorParameterConverter getConnectorParameterConverter() {
        return new DorisCatalogConnectorParameterConverter();
    }
